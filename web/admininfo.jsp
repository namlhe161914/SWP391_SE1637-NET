<%-- 
    Document   : admininfo
    Created on : Oct 10, 2022, 1:56:01 PM
    Author     : Admin
--%>
                            ...
                            <div class="container">
                                <div class="row d-flex justify-content-center align-items-center h-100">
                                    <div class="col-12 col-md-9 col-lg-7 col-xl-6 mb-4">
                                        ...
                                        <div class="mb-3 fw-bold">
                                            Phone: <span class="fw-lighter">${sessionScope.account.phone eq null ? "Null" : sessionScope.account.phone}</span>
                                        </div>
                                        <!-- Change profile btn -->
                                        <span>
                                            ...
                                            <div class="modal fade" id="changeProfileBtn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="ChangeUserInfo" method="POST" id="update-form">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div id="change-psw-error" class="form-outline mt-3 fst-italic text-center"
                                                             style="color: red; font-size: 18px;"></div>
                                                        <form action="ChangeUserInfo" method="POST" id="change-psw-form">
                                                            <div class="modal-body">
                                                                <!-- Old password -->
                                                                <div class="form-outline mb-3">
