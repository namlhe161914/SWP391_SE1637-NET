                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div id="wrapper">
                                    <form action="UpdateInforController" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <input type="hidden" name="accId" value=${sessionScope.account.getAccId()}>
                                            <input name="iId" type="hidden" value="${requestScope.infor.iId}">
                                            <div class="form-outline mb-3">
                                                <label class="form-label" for="name3Example">Titles <span style="color: red; font-weight: bold">*</span></label>
                                                <input type="text" id="title" class="form-control form-control-lg" value="${requestScope.infor.getTitle()}"
                                                required name="title"/>
                                            </div>
                                            <div class="form-outline mb-3">
                                                ...
                                                <select name="id" class="form-select form-select-lg" id="cate3Example">
                                                    <c:forEach items="${requestScope.listCate}" var="LC">  
                                                        <c:if test="${LC.id eq requestScope.infor.id}"><option hidden="" value ="${requestScope.infor.id}" name="id">${LC.name}</option></c:if>
                                                    </c:forEach>  
                                            ...
                                            <div class="form-outline mb-3">
                                                ...
                                                <input type="text" id="description" class="form-control form-control-lg" value="${requestScope.infor.description}"
                                            ...
                                            <div class="form-outline mb-3">
                                                ...
                                                <input type="text" id="coverImgPath" class="form-control form-control-lg"
                                                       name="coverImgPath" hidden="" value="${requestScope.infor.coverImgPath}"/>
                                                <img src="${requestScope.infor.coverImgPath}" id="preview" width="300px" height="190px">
                                            </div>
                                        </div>
                                        <div>
                                            <textarea id="editor" cols="30" rows="30" name="content">${requestScope.infor.content}</textarea>
                                        </div>
                                        <div class="modal-footer">
                                            <button id="update-profile-btn" type="submit">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
